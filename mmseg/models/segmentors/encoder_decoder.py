...
class EncoderDecoder(BaseSegmentor):
    ...
    def encode_decode(self, img, img_metas):
        ...
        save_dir='/data/Huyongkang/code/2023ACM-Pipo/P2V/isprs_add_all/featurev2p/'
        feature = fuse_x.cpu()
        save_path =  os.path.join(save_dir, f"{img_metas[0]['ori_filename']}.npy")
        np.save(save_path, feature.numpy()) 
